    ...
    >
      ...
      >
        <div
          ...
          @click.stop
        >
          <div class="px-6 py-4 bg-zinc-800/30 border-b border-zinc-700/50 flex items-center justify-between">
          ...
          <div class="p-6 space-y-4">
            <p class="text-zinc-400 text-sm leading-relaxed">
              A análise estrutural irá verificar a clareza, tokens e potenciais ambiguidades do seu texto atual.
            </p>
